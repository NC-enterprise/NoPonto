              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    <h3 className="sr-only">Tipo de coletados</h3>
                    <ul role="list" className="px-2 py-3 font-medium text-gray-900">
                      {subCategories.map((tipoColeta) => (
                        <li key={tipoColeta.name}>
                          <a href={tipoColeta.href} className="block px-2 py-3">
                            {tipoColeta.name}
                          </a>
                        </li>
                      ))}
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                <h3 className="sr-only">Campanhas Especiais</h3>
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-black">
                  {subCategories.map((campanha) => (
                    <li key={campanha.name}>
                      <a href={campanha.href}>{campanha.name}</a>
                    </li>
                  ))}
                </ul>
