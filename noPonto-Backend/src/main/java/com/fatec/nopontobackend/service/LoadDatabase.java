...
public class LoadDatabase {
    ...
    CommandLineRunner initDatabase(IPointRepository repository) {
        return args -> {
            ...
            Point ponto1 = new Point("images/ecoponto.png", "ECOPONTO ARCO ÍRIS", "contato@ponto2.com", "11978658976","SP","Diadema", -46.60199321652654,
            ...
            Point ponto2 = new Point("images/oleo.png", "Dr. óleo", "contato@ponto1.com", "11988758932","SP","Diadema", -46.61210735126725,
            ...
            Point ponto3 = new Point("images/eletronicos.png", "Dinâmica Ambiental", "contato@ponto3.com", "11988653214","SP","Diadema", -46.60953630533283,
